    ...
    <div class="full-height">
        ...
        >
            ...
            <template #SettingsComponent>
                <settings-component ref="SettingsComponentRoot"></settings-component>
            </template>
            <template #Content2>
...
import { GoldenLayout, SettingsComponent } from './components/index';

const GLayoutRoot = ref<null | typeof GoldenLayout>(null);
const SettingsComponentRoot = ref<null | typeof SettingsComponent>(null);
...
const onClickAddGlComponent1 = () => {
    if (!GLayoutRoot.value) return;
    GLayoutRoot.value.addGlComponent('Content1', 'Title 1st', { abc: 'Some data' });
};

const onClickAddGlComponent2 = () => {
    if (!GLayoutRoot.value) return;
    GLayoutRoot.value.addGlComponent('Content2', "I'm anchos");
};
